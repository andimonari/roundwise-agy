    ...
    <footer className="bg-slate-900 text-slate-400 text-xs border-t border-slate-800 mt-auto">
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-slate-400 text-xs mt-1 leading-relaxed max-w-4xl">
                  Panelwise Speciality is an independent simulation technology and preparation platform operated by Panelwise Speciality Technologies Ltd. 
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10">
        <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
          <div className="md:col-span-2 space-y-3">
            <div className="flex items-center gap-2">
              ...
              <span className="text-white font-bold text-base tracking-tight">Panelwise Speciality</span>
            </div>
        ...
        <div className="border-t border-slate-800 mt-8 pt-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px] text-slate-500">
          <div>
            © 2026 Panelwise Speciality Technologies Ltd. All rights reserved. Registered in England & Wales.
          </div>
